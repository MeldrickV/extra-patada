...
- [x] Debt: lint baseline cleanup, more JVM tests, dead-code removal (phase 11): dead code removed, `warningsAsErrors` enforces no new lint, combined-paging + mapper JVM tests
